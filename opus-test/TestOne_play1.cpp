...
void doPlay1(bool aShowFlag, double aSkip)
{
   int tRet;
...
void doStopPlay1()
{
   ...
   printf("play1 stopping 1\n");
   pa_threaded_mainloop_stop(mMainLoop);
   printf("play1 stopping 2\n");
   pa_stream_disconnect(mStream);
   printf("play1 stopping 3\n");
   pa_context_disconnect(mContext);
   printf("play1 stopping 4\n");
